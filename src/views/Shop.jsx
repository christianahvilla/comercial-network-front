...
const Shop = () => {
    ...
    return(
        <div className="mainBody">
            <ShopModal show={show} handleClose={() => setShow(!show)}title="Crear tienda" text="aqui va el formulario"/>
            <ShopModal title="Actualizar tienda" text="aqui va el formulario"/>
            <DefaultTitle text="Tiendas"/>
            <DefaultButton variant="primary" text="Crear tiendad" onClick={() => setShow(!show)}/>
            <br></br>
            <Table/>
        </div>
    )
